  ...
  <div>
    <div v-if="closeOrder" class="p-40 text-center text-3xl text-green-600 font-light flex flex-col items-center">
      ...
      <span class="p-10 text-gray-600 font-light">
        GRUPO CVL agradece su participación en el concurso, no pondremos en contacto una vez culminado el proceso
      </span>
    </div>
    <div v-else>
          ...
          <div class="col-span-10 border rounded-md border-b p-4">
              ...
              <div class="grid grid-cols-12 gap-2 w-full mt-4">
                <div class="col-span-3">
                  <ul v-for="mySupplier in store.getters.getSupplier(country)" :key="mySupplier.nombre">
                    <li
                      class="flex justify-between border-l-8 border-l-sky-500 p-2 border mb-1 border-gray-300 border-r-gray-600 rounded-md border-r-8 rounded-l-full shadow hover:bg-cyan-500 text-sm"
                ...
                <div class="col-span-8 bg-slate-100 p-4" v-if="supplier">
                  ...
                  <div class="grid grid-cols-8 gap-2">
                    <label :for="qoute.portOrigin" class="col-span-2 text-end text-sm">Puerto Origen:</label>
            ...
            <div v-if="!country">
                  ...
                  <tbody>
                    <tr v-for="myQoute, idx in store.state.supplierQoutes " :key="myQoute"
                      ...
                      <td class="border">
                        {{ myQoute.country }}
                        <br />
                        <small class="text-xm text-slate-600 font-light">{{ myQoute.supplier.nombre }}</small>
                      </td>
              ...
              <div class="bg-red-100 p-10 rounded mt-5 flex justify-between">
                ...
                <button v-if="confirmSend" class="btn btn-md btn-success text-white font-light" @click="sendData">
