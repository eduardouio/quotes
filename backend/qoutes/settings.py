"""
Django settings for qoutes project.
...
SECRET_KEY = 'django-insecure-87o+3#lahx50*)ea6b+7%9@#4^mt%1+5*92o@(oomrf1o@hh*x'
...
WSGI_APPLICATION = 'qoutes.wsgi.application'
